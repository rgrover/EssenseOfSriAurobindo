...
\title{\bf The Essence of Sri Aurobindo}
\date{}
...
\item His spiritual experiences were recorded in detail, in English,
...
reader a powerful tool for gaining access into the spiritual words.
...
that he may find. He is also the frustration we (\emph{He}) feels in the
...
these high planes where its purity will enrich the experience and vice
versa. A third means is also legitimate, although more limiting:
...
this \emph{sound} with its inbuilt \emph{rhythm} that is the magic wand for
opening the doors to the inner worlds. And the \emph{sound} is saying
that these two opposites can exist and operate together, at the same
time. And even the joy in their play (possibly for fooling us) can be
``felt'' if our outer minds can let go of their conditional responses
like ``give me a break!'', ``be serious!''  The arrangement of words
and their overall \emph{sound} should have enough power to create
something beautiful, even if their logic troubles your mind.
...
the \emph{rhythm sound} was most important.  To support this idea, we
have a quotation from Sri Aurobindo's commentary on the Kena
Upanishad:
...
rhythms, [\ldots] it is no disordered vibration, but moves out into
great cosmic measures,---and according to the rhythm is the law,
...
Matter. It is as if reality hid itself so that non-reality could have
