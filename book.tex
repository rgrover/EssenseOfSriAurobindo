...
\usepackage[hmargin={3.95cm,3.25cm}]{geometry}
\usepackage{fancyhdr}
...
describe the process of creation, their ultimate aim and climactic end
...
however dim the sound, himself causing the dimness. This ``rest of the
