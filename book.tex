...
%% \usepackage[hmargin={4.4cm,3.78cm}]{geometry} % inner=2.7cm; outer=2.3cm
%% \usepackage[hmargin={3.6cm,3.6cm}]{geometry}  % inner=outer=2.2cms
\usepackage[hmargin={3.95cm,3.25cm}]{geometry} %inner = 2.4cms; outer=2.0 (calculated--i.e. not verified by actual measurement)
\usepackage{fancyhdr}
%% \usepackage{graphicx}
...
\begin{verse}
``A soul that is a spark of God survives.'' \footnote {Sri Aurobindo; Part one,CWSA vol 33, p.169}
\end{verse}
